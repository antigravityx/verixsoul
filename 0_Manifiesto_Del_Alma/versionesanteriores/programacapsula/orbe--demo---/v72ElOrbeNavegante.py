    ...
    while True:
        ...
        try:
            ...
            for i, filename in enumerate(files):
                log_mensaje(f"  {len(dirs) + i + 1}. {filename}", "azul")

            log_mensaje("\nOpciones:", "cian")
            log_mensaje("  [número] - para entrar a una carpeta", "gris")
...
def main_loop():
    ...
    registrar_evento("INICIO DEL ORBE", f"Versión del Orbe: 7.2 (El Orbe Navegante)", prioridad="IMPORTANTE")
